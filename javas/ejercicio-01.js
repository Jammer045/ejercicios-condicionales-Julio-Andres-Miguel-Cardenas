...
if (numeroIngresado>5) {console.log("Casi, el numero secreto es menor: Intenta nuevamente (Intentos restantes: 2)");
    
} else if (numeroIngresado<5) {console.log("Casi, pero el numero secreto es superior, intenta nuevamente (intentos resatantes: 2)");
    
} else if (numeroIngresado==5) {console.log("Ganaste haz adivinado el numero: Felicitaciones :)");
    
}

numeroIngresado = prompt ("Ingrese aqui su numero:")

if (numeroIngresado>5) {console.log("Casi, el numero secreto es menor: Intenta nuevamente (Intentos restantes: 1)");
    
} else if (numeroIngresado<5) {console.log("Casi, pero el numero secreto es superior, intenta nuevamente (intentos resatantes: 1)");
...
if (numeroIngresado>5) {console.log("Casi, el numero secreto era menor: Game Over :(");
    
} else if (numeroIngresado<5) {console.log("Casi, pero el numero secreto era superior: Game over");
    
} 

if (numeroIngresado==5) {console.log("Ganaste: haz adivinado el numero: Felicitaciones :)");
